...
export const Xcategories = (props) => {
  return (
    <div className='configHeatMap form-group px-3'>
      <input
        type='text'
        onChange={props.changed}
        className='form-control'
...
export class HeatMapConfiguration extends Component {
  state = {
    ...
    xcategories: [{ id: "x0" }, { id: "x1" }, { id: "x2" }, { id: "x3" }],
          ...
          <div className='col-md-9'>
            ...
            <div className='gridOneContainer'>
              <form onSubmit={this.handleSubmit} className='gridform'>
                <span className='grid-container-four-cross-five'>
                ...
                <div className='text-center mt-5'>
                  ...
                  <div className='mt-3'>
                    <span className='form-group text-center'>
